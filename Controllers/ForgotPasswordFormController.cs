...
public class ForgotPasswordFormController : SurfaceController
{
    ...
    [HttpPost]
    //public IActionResult Submit(ForgotPasswordModel model)
    public async Task<IActionResult> Submit(ForgotPasswordModel model)
    {
        
         TempData["ResetSent"] = null;
        ...
        if (member != null)
        {
            ...
            // 20-07-2025 - This token value needs to be saved in Cookie with a lifetime of 24 hours
            ...
            HttpContext.Response.Cookies.Append("ResetToken", token, new CookieOptions
            {
